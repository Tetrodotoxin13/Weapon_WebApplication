...
<body>
    <center>
        ...
        <h2>Select the first weapon and check the statistics</h2>
    <div class="container">
    <div class="row">
        <div class="col-sm-4">
          <form action="" method="POST">
                  <input type="text" name="id" placeholder="First number">
                  <input type="submit" name="search" value="Search first">
                  <br> <br>
