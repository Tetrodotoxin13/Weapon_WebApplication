...
<body>
  ...
  <div class="jumbotron" style="margin-bottom:0">
    ...
    <p class="feketeszoveg">"The deadliest weapon in the world is a Marine and his rifle!" (General John J. Pershing)</p>
    <p class="feketeszoveg">"Concentrated power has always been the enemy of liberty." (Ronald Reagan)</p>
  </div>
  ...
  <?php
    require_once '../html/newstext.html'
  ?>
  ...
  <b class="feketeszoveg">The game received generally positive reviews from critics, with the maps receiving specific praise. In May 2020, 
    ...
    <p class="feketeszoveg">#For Entertainment#</p>
      ...
      <div>
        ...
        <div class="container">
          <h2 class="feketeszoveg">Call Of Duty WARZONE: THIS WILL CHANGE How You Create LOADOUTS! (Secrets & Tips)</h2>
          <div class="embed-responsive embed-responsive-16by9">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/AxpXPIrKKyU?autoplay=1&mute=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>      </div>
